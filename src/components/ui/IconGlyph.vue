...
const paths: Record<string, string[]> = {
  ...
  plug2: ['m7 11 10-10', 'm11 13 10-10', 'm7 11 2 2', 'm17 3-6 6', 'M7 21a2 2 0 0 1-4 0v-7a2 2 0 0 1 4 0Z'],
  ...
  route: ['M2 12h8', 'M22 12h-8', 'M12 2v8', 'M12 22v-8', 'M6 6l12 12', 'M18 6 6 18'],
  sparkle: [
